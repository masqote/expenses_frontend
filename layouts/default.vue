      ...
      <nav class="flex-1 px-3 space-y-1 overflow-y-auto">
        ...
        >
          <span class="flex items-center gap-3">
            ...
            <svg v-if="item.icon==='mail'" class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/></svg>
            {{ item.label }}
          </span>
    ...
    <div class="flex-1 lg:ml-64 flex flex-col min-h-screen min-w-0 overflow-x-hidden">
      ...
      <nav class="lg:hidden fixed bottom-0 left-0 right-0 bg-[#1a1825] border-t border-white/5 z-20 flex" style="padding-bottom: env(safe-area-inset-bottom, 0px)">
        ...
        >
          ...
          <svg v-if="item.icon==='mail'" class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/></svg>
      ...
      <main class="flex-1 overflow-y-auto overflow-x-hidden w-full" style="padding-bottom: calc(4rem + env(safe-area-inset-bottom, 0px))">
        <slot />
      </main>
    </div>
  </div>
